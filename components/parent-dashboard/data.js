...
export const parentNotifications = [
  {
    id: 1,
    title: "Principal's Circular: Parent Connect Meet",
    message: "Parent interaction session is scheduled on Friday. Please confirm attendance before 5 PM.",
  ...
  {
    id: 2,
    title: "Class Teacher Update: Maths Support Plan",
    message: "A focused revision worksheet has been shared to improve equation-solving confidence this week.",
  ...
  {
    id: 3,
    title: "PET Message: Practice Session",
    message: "Athletics practice will start 30 minutes early tomorrow. Please send sports shoes and water bottle.",
    sourceRole: "PET",
  ...
  {
    id: 4,
    title: "Transport Notice: Route Delay",
    message: "Morning bus route for your area may run 10 minutes late due to road maintenance.",
  ...
  {
    id: 5,
    title: "Exam Cell Reminder",
    message: "Unit test timetable has been published. Please review subjects and dates with your child.",
  ...
  {
    id: 6,
    title: "Counsellor Note",
    message: "Weekly well-being check is available on request for students preparing for exams.",
  ...
  },
  {
    id: 7,
    title: "Library Alert",
    message: "One library book return is pending. Please submit by Monday to avoid a late fee.",
    sourceRole: "Library",
  ...
  {
    id: 9,
    title: "Principal Update: Safety Drill",
    message: "A safety preparedness drill is planned this week. Students should follow teacher instructions.",
    sourceRole: "Principal",
    sourceName: "Dr. N. Sreenivas",
    category: "School",
    priority: "medium",
  ...
  {
    id: 10,
    title: "PET Follow-up: Fitness Log",
