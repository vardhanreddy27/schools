...
const STATIC_HOMEWORK = [
  {
    ...
    instructions: ["Exercise 1.2: Q1 to 6 in notebook.", "Write a 120-word letter."],
  },
  {
    id: 3,
    subject: "Telugu",
    title: "Reading",
    imageSrc: "/telugu.png",
    chapter: "Path 2: Reading & Comprehension",
    instructions: ["Read Page 12 aloud 3 times.", "Write meanings for 10 words."],
  },
  {
    id: 2,
    subject: "Maths",
    title: "Geometry",
    imageSrc: "/maths.png",
    chapter: "Chapter 4: Geometry & Shapes",
    instructions: ["Construct a triangle (5cm, 6cm, 7cm).", "Solve Page 84 Problems."],
  },
  {
    id: 4,
    subject: "Hindi",
    title: "Poem",
    imageSrc: "/hindi.webp",
    chapter: "Hindi Lesson 3: Nature Poem",
    instructions: ["Memorize first 8 lines.", "Write summary in your words."],
  },
...
export default function HomeworkTab() {
  ...
  const groupedAssignments = useMemo(() => {
    ...
    studentAssignments.forEach((item) => {
      ...
      // Added dummy details for each assignment task
      grouped[item.subject].tasks.push({
        title: item.title,
        desc: "Research and compile a 2-page report including diagrams and references.",
                ...
                <div className="p-5">
                  ...
                  {isExpanded && (
                    <div className="mt-4 pt-4 border-t border-slate-100 animate-in fade-in">
                      <p className="text-[10px] font-black uppercase text-slate-400 tracking-wider">Chapter Details</p>
                      <p className="mt-1 text-sm font-bold text-slate-800">{hw.chapter}</p>
