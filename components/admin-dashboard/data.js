...
export const attendanceTrend = {
  Today: [
    { label: "I", students: 176 },
    { label: "II", students: 189 },
    { label: "III", students: 182 },
    { label: "IV", students: 194 },
    { label: "V", students: 185 },
    { label: "VI", students: 199 },
    { label: "VII", students: 204 },
    { label: "VIII", students: 206 },
    { label: "IX", students: 218 },
    { label: "X", students: 230 },
  ],
  Weekly: [
    { label: "I", students: 182 },
    { label: "II", students: 196 },
    { label: "III", students: 188 },
    { label: "IV", students: 201 },
    { label: "V", students: 190 },
    { label: "VI", students: 206 },
    { label: "VII", students: 211 },
    { label: "VIII", students: 214 },
    { label: "IX", students: 226 },
    { label: "X", students: 238 },
  ],
  Monthly: [
    { label: "I", students: 178 },
    { label: "II", students: 191 },
    { label: "III", students: 184 },
    { label: "IV", students: 197 },
    { label: "V", students: 187 },
    { label: "VI", students: 202 },
    { label: "VII", students: 207 },
    { label: "VIII", students: 209 },
    { label: "IX", students: 221 },
    { label: "X", students: 233 },
  ],
};
